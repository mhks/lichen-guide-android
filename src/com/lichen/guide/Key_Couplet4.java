...
public class Key_Couplet4 extends ListActivity {

//	public static IndexList context;
	
	@Override
	public void onCreate(Bundle savedInstanceState) {
	  super.onCreate(savedInstanceState);

	  String[] countries = getResources().getStringArray(R.array.couplet4);
	    ...
	    public void onItemClick(AdapterView<?> parent, View view,
	    	...
	    	switch (position){
	    		case 0: 
	    			...
	    			AlertDialog.Builder builder = new AlertDialog.Builder(Key_Couplet4.this);
	    			builder.setMessage("Lobaria")
	    			       .setCancelable(false)
	    			       .setPositiveButton("Go to Index", new DialogInterface.OnClickListener() {
	    			           public void onClick(DialogInterface dialog, int id) {
	    			        	   Intent newActivity0 = new Intent(Key_Couplet4.this, IndexList.class);
	    		...
	    		break;
	    		 ...
	    		 case 1:  Intent newActivity1 = new Intent(Key_Couplet4.this, Key_Couplet5.class);     
