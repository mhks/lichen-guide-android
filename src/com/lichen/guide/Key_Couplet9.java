...
public class Key_Couplet9 extends ListActivity {

	@Override
	public void onCreate(Bundle savedInstanceState) {
	  super.onCreate(savedInstanceState);

	  String[] countries = getResources().getStringArray(R.array.couplet9);
	  ...
	  lv.setOnItemClickListener(new OnItemClickListener() {
	    public void onItemClick(AdapterView<?> parent, View view,
	    	...
	    	switch (position){
	    		case 0: 	AlertDialog.Builder builder = new AlertDialog.Builder(Key_Couplet9.this);
    			builder.setMessage("Cetraria")
			       .setCancelable(false)
			       .setPositiveButton("Go to Index", new DialogInterface.OnClickListener() {
			           public void onClick(DialogInterface dialog, int id) {
			        	   Intent newActivity0 = new Intent(Key_Couplet9.this, IndexList.class);
			...
			.setNegativeButton("Back to Key", new DialogInterface.OnClickListener() {
	    		...
	    		break;
	    		 ...
	    		 case 1:  	AlertDialog.Builder builder2 = new AlertDialog.Builder(Key_Couplet9.this);
	    			builder2.setMessage("Melanelixia")
 			       .setCancelable(false)
 			       .setPositiveButton("Go to Index", new DialogInterface.OnClickListener() {
 			           public void onClick(DialogInterface dialog, int id) {
 			        	   Intent newActivity0 = new Intent(Key_Couplet9.this, IndexList.class);
