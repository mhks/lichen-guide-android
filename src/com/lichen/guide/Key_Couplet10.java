...
public class Key_Couplet10 extends ListActivity {

	@Override
	public void onCreate(Bundle savedInstanceState) {
	  super.onCreate(savedInstanceState);

	  String[] countries = getResources().getStringArray(R.array.couplet10);
	  ...
	  lv.setOnItemClickListener(new OnItemClickListener() {
	    public void onItemClick(AdapterView<?> parent, View view,
	    	...
	    	switch (position){
	    		case 0: 	AlertDialog.Builder builder = new AlertDialog.Builder(Key_Couplet10.this);
    			builder.setMessage("Peltigera")
			       .setCancelable(false)
			       .setPositiveButton("Go to Index", new DialogInterface.OnClickListener() {
			           public void onClick(DialogInterface dialog, int id) {
			        	   Intent newActivity0 = new Intent(Key_Couplet10.this, IndexList.class);
			...
			.setNegativeButton("Back to Key", new DialogInterface.OnClickListener() {
	    		...
	    		break;
	    		 ...
	    		 case 1:  Intent newActivity1 = new Intent(Key_Couplet10.this, Key_Couplet11.class);     
