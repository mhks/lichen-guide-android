...
public class Key_Couplet11 extends ListActivity {

	@Override
	public void onCreate(Bundle savedInstanceState) {
	  super.onCreate(savedInstanceState);

	  String[] countries = getResources().getStringArray(R.array.couplet11);
	  ...
	  lv.setOnItemClickListener(new OnItemClickListener() {
	    public void onItemClick(AdapterView<?> parent, View view,
	    	...
	    	switch (position){
	    		case 0: Intent newActivity0 = new Intent(Key_Couplet11.this, IndexList.class);
	    		startActivity(newActivity0);
	    		break;
	    		
	    		 case 1:  Intent newActivity1 = new Intent(Key_Couplet11.this, Key_Couplet12.class);     
